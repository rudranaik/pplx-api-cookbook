...
![Perplexity Client Interface](../static/img/perplexity-client-main.png)
...
| Feature | Preview |
|---------|---------|
| Spaces (Custom Instructions) | ![Spaces](../static/img/perplexity-client-spaces.png) |
| Model & Parameter Controls | ![Parameters](../static/img/perplexity-client-parameters.png) |
| API Debugging Mode | ![Debug](../static/img/perplexity-client-debug.png) |
| Theme Selection | ![Themes](../static/img/perplexity-client-themes.png) |
